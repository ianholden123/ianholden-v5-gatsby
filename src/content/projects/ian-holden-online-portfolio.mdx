...
colourScheme: { primary: '#ffffff', secondary: '#f2f2f2', tertiary: '#a6a6a6' }
contributors: ''
date: '2019-10-04'
...
toolsUsed: ['Gatsby', 'Markdown', 'React']
...
<figure>
  <img
    src="https://s3-eu-west-2.amazonaws.com/ianholden.co.uk-wordpress-media/wp-content/uploads/2020/05/05082930/Screenshot-2020-05-05-at-09.28.52-1024x727.png"
    alt="Ian Holden website home page"
  />
  <figcaption>
    The site’s monochromatic colour scheme allows the coloured interactive
    sections to stand out to the user.
  </figcaption>
</figure>
